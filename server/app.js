...
/*** endpoints for analog in 1-2 */
app.use('/api/v1/ai/1', indexRouter);
app.use('/api/v1/ai/2', indexRouter);

app.use('/api/v1/PT/1', indexRouter);
app.use('/api/v1/PT/2', indexRouter);
...
/*app.post('/api/v1/ao/1', (request,response) => {
